...
function buildPortrait(jobName: string, category: string): ManualJobPortraitRecord {
  return {
    job_name: jobName,
    category,
    skills: { level: 4, weight: 0.28, description: "掌握岗位核心能力" },
    certification: { level: 2, weight: 0.05, description: "相关认证可加分" },
    innovation: { level: 3, weight: 0.12, description: "可提出改进方案" },
    learning: { level: 4, weight: 0.15, description: "能快速学习新工具" },
    stress: { level: 3, weight: 0.12, description: "能应对交付压力" },
    communication: { level: 4, weight: 0.14, description: "能跨团队沟通" },
    experience: { level: 3, weight: 0.14, description: "有项目经验优先" },
